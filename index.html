...
<body>
  ...
  <header id="header">
    <div class="container">
      ...
      <h2>I believe one day we will cure scinesence, I just home it's in my lifetime</h2>
  ...
  <section id="resume" class="resume">
    <div class="container">
      ...
      <div class="section-title">
        <h2>I haven't scratched the surface</h2>
        <p>THE INNOVATOR'S JOURNEY</p>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            ...
            <p><em>Innovative and deadline-driven software engineer with 8+ years of experience designing and developing
               user-centered digital/print marketing material from initial concept to final, polished deliverable.</em></p>
            <p>
            <ul>
              <li>123, Johannesburg, Gauteng</li>
              <li>(078) 369 5417</li>
              <li>siyabot009@gmail.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            <h4>BSC in Copmuter Science</h4>
            <h5>2011 - 2014</h5>
            <p><em>University Of Cape Town, Cape Town</em></p>
            <p> I pursued Computer science while studying Animation at the animation</p>
          </div>
          <div class="resume-item">
            <h4>Diplomar &amp; Graphic and Animation</h4>
            <h5>2011 - 2013</h5>
            <p><em>The Animation Schol, Cape Town, S.A </em></p>
            <p>Animation was the one thing that made want to know how computers and work and inpired me to enroll for a Computer Science Degree in the dame year</p>
          </div>
          <div class="resume-item">
            <h4>(SHort course) &amp; Graphic Design</h4>
            <h5>2012 - 2012</h5>
            <p><em>College Of Cape Town, Cape Town</em></p>
            <p>In the the Animation there was a lot of print and photography related topics that we deal with efficiently and I had a Job coming in GD so I tool a short corse.</p>
          </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="resume-item">
            <h4>Senior DEveloper | Kamover</h4>
            <h5>2020 - Present</h5>
            <p><em>Pretora, Gauteng, S.A</em></p>
            <p>
            <ul>
          ...
          <div class="resume-item">
            <h4>Laumbda specialist | AWS</h4>
            <h5>2017 - 2018</h5>
            <p><em>Amazon Developed Center, Cape Town S.A</em></p>
            <p>
            <ul>
              <li>Developed numerous marketing programs (logos, brochures,infographics, presentations, and advertisements).</li>
              <li>Managed up to 5 projects or tasks at a given time while under pressure</li>
          ...
          <div class="resume-item">
            <h4>RealPhandaz | Head Data Architect</h4>
            <h5>2015 - 2017</h5>
            <p><em>Amazon Developed Center, Cape Town S.A</em></p>
            <p>
            <ul>
          ...
          <div class="resume-item">
            <h4>Junior graphic designer (Intern)</h4>
            <h5>2013 - 2013</h5>
            <p><em> IMBO LIVE | Green Point Cape Twon </em></p>
            <p>
            <ul>
